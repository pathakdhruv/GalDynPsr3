...
def Pdotintcalerr(Ex_pl, Ex_z, Ex_shk, errpl, errz, errshk):
   ...
   pdotbypdyn = a+b+c
   dtos = 24.0*3600.0
   inp = input("Do you want (1)- Only intrinsic spin period derivative, (2)- Only intrinsic orbital period decay, or, (3)- Both? Choose 1, 2, or 3: ")
   if inp == "1":
       Psraw,sigPsraw = input("\nEnter spin period- Ps (s), error in spin period [separated by a comma] ").split((','))
       Psdot_obsraw,sigPsdot_obsraw  = input("Enter observed spin period derivative- Psdot_obs, error in observed spin period derivative [separated by a comma] ").split((','))
       Ps = float(Psraw)
       ...
       Pbdraw,sigPbdraw = input("\nEnter orbital period- Pb (days), error in orbital period [separated by a comma] ").split((','))
       Pbdot_obsraw,sigPbdot_obsraw  = input("Enter observed orbital period derivative- Pbdot_obs, error in observed orbital period derivative [separated by a comma] ").split((','))
       Pbd = float(Pbdraw)
       ...
       Psraw,sigPsraw = input("\nEnter spin period- Ps (s), error in spin period [separated by a comma] ").split((','))
       Pbdraw,sigPbdraw = input("Enter orbital period- Pb (days), error in orbital period [separated by a comma] ").split((','))
       Psdot_obsraw,sigPsdot_obsraw  = input("Enter observed spin period derivative- Psdot_obs, error in observed spin period derivative [separated by a comma] ").split((','))
       Pbdot_obsraw,sigPbdot_obsraw  = input("Enter observed orbital period derivative- Pbdot_obs, error in observed orbital period derivative [separated by a comma] ").split((','))
...
def Pdotintcal(Ex_pl, Ex_z, Ex_shk,flag2):
   ...
   if inp == "1":
       Psraw = input("\nEnter Ps (s) = ")
       Psdot_obsraw = input("Enter Psdot_obs = ")
       ...
       Pbdraw = input("\nEnter Pb (days) = ")
       Pbdot_obsraw = input("Enter Pbdot_obs = ")
